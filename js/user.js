$(document).ready(function() {
	//trigger popup div when login is clicked
	...
	//trigger register popup div when register link is clicked
	...
	//Trigger for when submit is clicked on our popup login div
	$("body").on('click', 'input.submit', function(event){
		signIn(); 
	});
	//Trigger for when submit is clicked on our popup register div
	...
	function signIn(){
		var valid = true; //validation variable if everything is validated then this will remain true
		$("p.log").remove(); //removes any old errors
	...
	//Function for when a user wants to register
